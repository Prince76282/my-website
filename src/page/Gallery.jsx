...
const Gallery = () => {
  ...
  return (
    <section className="relative p-6 sm:p-10 bg-gradient-to-b from-white via-yellow-50 to-orange-50 min-h-screen overflow-hidden">
      {/* Glow Background */}
      <div className="absolute top-[-80px] left-[-80px] w-80 h-80 bg-orange-300 opacity-20 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-[-80px] right-[-80px] w-96 h-96 bg-yellow-300 opacity-20 rounded-full blur-3xl animate-pulse"></div>
      ...
      >
        ...
        {showPreview && (
          <div
            className="fixed mt-20  inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4"
          ...
          >
            ...
            <button
              ...
              className="absolute top-5 rounded-md right-4 bg-orange-500  text-red-600 hover:bg-red-600 hover:text-white transition-all duration-300 p-2 text-2xl  shadow-xl z-50"
            >
              &times;
            </button>

            {/* Content (Prevent click propagation) */}
            <div
            ...
            >
              ...
              <motion.img
                ...
                className="w-[70vw] max-h-[80vh] rounded-xl shadow-2xl object-contain"
        ...
        {/* Image Grid */}
        <div className="grid grid-cols-2 mt-8 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {visibleImages.map((img, index) => (
            ...
            >
              <img
                ...
                src={img.src}
                alt={img.alt}
                className="w-full h-64 sm:h-72 object-cover transform group-hover:scale-110 group-hover:rotate-1 group-hover:brightness-90 transition-all duration-500"
              />
